  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["folder-folder-module"], {
    ...
    function node_modulesFuseJsDistFuseEsmJs(module, __webpack_exports__, __webpack_require__) {
      ...
      function search(text, pattern, patternAlphabet) {
        ...
        for (var _i3 = 0; _i3 < patternLen; _i3 += 1) {
                ...
                case LogicalOperator.OR:
                  {
                    ...
                    for (var _i4 = 0, _len = node.children.length; _i4 < _len; _i4 += 1) {
                      var _child = node.children[_i4];
    ...
    /***/
    function node_modulesRawLoaderDistCjsJsSrcAppModalsAddItemAddItemComponentHtml(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_exports__["default"] = "<ion-header>\n  <ion-toolbar>\n    <ion-buttons slot=\"start\" color=\"dark\">\n      <ion-button (click)=\"dismiss()\" color=\"dark\">\n        <ion-icon slot=\"icon-only\" name=\"arrow-back\"></ion-icon>\n      </ion-button>\n    </ion-buttons>\n    <ion-title>\n      Add Item\n    </ion-title>\n  </ion-toolbar>\n</ion-header>\n<ion-content>\n  <ion-card>\n    <ion-card-content>\n      <ion-item>\n        <ion-label position=\"stacked\">Food Title</ion-label>\n        <ion-input type=\"text\" [(ngModel)]=\"item.name\" style=\"height: 50px;\" autocomplete=\"on\" autocorrect=\"on\">\n        </ion-input>\n      </ion-item>\n      <ion-item>\n        <ion-label style=\"color: black\" position=\"stacked\" text-wrap>\n          How does it make you feel?\n        </ion-label>\n        <ion-select placeholder=\"Select One\" [(ngModel)]=\"feeling\">\n          <ion-select-option value=\"0\">Awful</ion-select-option>\n          <ion-select-option value=\"1\">Okay</ion-select-option>\n          <ion-select-option value=\"2\">Great</ion-select-option>\n        </ion-select>\n      </ion-item>\n      <br>\n      <br>\n      <ion-button expand=\"block\" color=\"dark\" (click)=\"submit()\">Submit</ion-button>\n      <ion-button expand=\"block\" color=\"light\" (click)=\"dismiss()\">Cancel</ion-button>\n    </ion-card-content>\n  </ion-card>\n  <!--\n  <ion-list>\n\n    <ion-item style=\"padding-bottom: 15px\">\n      <ion-label style=\"color: black\" stacked>Food Title</ion-label>\n      <ion-input type=\"text\" [(ngModel)]=\"item.name\" style=\"height: 50px;\" autocomplete=\"on\" autocorrect=\"on\">\n      </ion-input>\n    </ion-item>\n\n    <ion-item>\n      <ion-label style=\"color: black\">\n        <div *ngIf=\"(feeling === 0); else showOkay\">Awful</div>\n        <ng-template #showOkay>\n          <div *ngIf=\"(feeling === 1); else showGreat\">Okay</div>\n        </ng-template>\n        <ng-template #showGreat>\n          <div *ngIf=\"(feeling === 2);\">Great</div>\n        </ng-template>\n      </ion-label>\n      <ion-range min=\"0\" max=\"2\" step=\"1\" snaps=\"true\" color=\"secondary\" [(ngModel)]=\"feeling\"></ion-range>\n    </ion-item>\n\n  </ion-list>\n  <button ion-button block style=\"color: white\" (click)=\"submit()\">Submit</button>\n  <div style=\"text-align:center\"><button ion-button small outline (click)=\"dismiss()\">Cancel</button></div>-->\n</ion-content>";
      /***/
    },
    ...
    function srcAppFolderFolderModuleTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var _modals_add_item_add_item_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! ../modals/add-item/add-item.component */
      "./src/app/modals/add-item/add-item.component.ts");
      ...
      FolderPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        declarations: [_folder_page__WEBPACK_IMPORTED_MODULE_6__["FolderPage"], _modals_add_item_add_item_component__WEBPACK_IMPORTED_MODULE_7__["AddItemComponent"]],
        entryComponents: [_modals_add_item_add_item_component__WEBPACK_IMPORTED_MODULE_7__["AddItemComponent"]]
      })], FolderPageModule);
      /***/
    },
    ...
    function srcAppFolderFolderPageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var _modals_add_item_add_item_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! ../modals/add-item/add-item.component */
      "./src/app/modals/add-item/add-item.component.ts");
      /* harmony import */
      ...
      var fuse_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      /*! fuse.js */
      "./node_modules/fuse.js/dist/fuse.esm.js");

      var FolderPage = /*#__PURE__*/function () {
        function FolderPage(activatedRoute, storage, router, modalCtrl, actionSheetController) {
          ...
          this.entryList = [];
          this.max = moment__WEBPACK_IMPORTED_MODULE_6__().format("YYYY-MM-DD");
          this.today = moment__WEBPACK_IMPORTED_MODULE_6__().format("YYYY-MM-DD");
          this.entry = {
            date: this.today,
            bms: 0
          };
        ...
        _createClass(FolderPage, [{
                ...
                while (1) {
                  switch (_context.prev = _context.next) {
                    case 0:
                      ...
                      _context.next = 3;
                      return this.storage.getItem("loggedInTracker");
          ...
          key: "custom_sort",
          value: function custom_sort(a, b) {
                  ...
                  switch (_context3.prev = _context3.next) {
                    case 0:
                      ...
                      return this.modalCtrl.create({
                        component: _modals_add_item_add_item_component__WEBPACK_IMPORTED_MODULE_4__["AddItemComponent"]
                      });
          ...
          key: "removeEntry",
          value: function removeEntry(item) {
                      ...
                      return this.actionSheetController.create({
                        ...
                        buttons: [{
                          ...
                          handler: function handler() {
                            for (var i = 0; i < _this9.entryList.length; i++) {
                              if (_this9.entryList[i].id == item.id) {
                                _this9.entryList.splice(i, 1);

                                _this9.storage.user.entries = _this9.entryList;
                                break;
                              }
                            }

                            _this9.storage.updateUser();
                          }
                        }]
                      });
                ...
                while (1) {
                  switch (_context6.prev = _context6.next) {
                    ...
                    case 3:
                      ...
                      fuse = new fuse_js__WEBPACK_IMPORTED_MODULE_8__["default"](this.itemList, options);
                      result = fuse.search(event);
                      console.log(result);
                      this.itemList = [];
              ...
              return regeneratorRuntime.wrap(function _callee8$(_context8) {
                while (1) {
                  switch (_context8.prev = _context8.next) {
                    case 0:
                      this.entry.id = Object(uuid__WEBPACK_IMPORTED_MODULE_7__["v4"])();
    ...
    /***/
    "./src/app/modals/add-item/add-item.component.scss":
    /*!*********************************************************!*\
      !*** ./src/app/modals/add-item/add-item.component.scss ***!
      \*********************************************************/
    ...
    /***/
    function srcAppModalsAddItemAddItemComponentScss(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_exports__["default"] = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL21vZGFscy9hZGQtaXRlbS9hZGQtaXRlbS5jb21wb25lbnQuc2NzcyJ9 */";
      /***/
    },
    ...
    /***/
    function srcAppModalsAddItemAddItemComponentTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var AddItemComponent = /*#__PURE__*/function () {
        function AddItemComponent(modalCtrl, storage) {
        ...
        _createClass(AddItemComponent, [{
          ...
          value: function submit() {
            ...
            this.item.id = Object(uuid__WEBPACK_IMPORTED_MODULE_4__["v4"])();
      ...
      AddItemComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-add-item',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! raw-loader!./add-item.component.html */
        "./node_modules/raw-loader/dist/cjs.js!./src/app/modals/add-item/add-item.component.html"))["default"],
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! ./add-item.component.scss */
        "./src/app/modals/add-item/add-item.component.scss"))["default"]]
      })], AddItemComponent);
      /***/
    }
  }]);
